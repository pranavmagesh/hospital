              ...
              <div class="text-sec">
                ...
                <ul class="row">
                  <li class="col-sm-6">
                    ...
                    <p>Emergency services to all patients at all time at lowest cost in the city</p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> QUALIFIED DOCTORS</h6>
                    <p>Best and qualified doctors who provides best services</p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> ONLINE APPOINTMENT</h6>
                    <p> place your appoint from your place any time</p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> FREE MEDICAL COUNSELING</h6>
                    <p>free medical counseling every month to get free medical advices</p>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <section class="p-t-b-150">
      <div class="container"> 
        ...
        <div class="heading-block">
          <h2>Our Services</h2>
          <hr>
          <span>we provide all specialist services at all department at best cost.</span> </div>
